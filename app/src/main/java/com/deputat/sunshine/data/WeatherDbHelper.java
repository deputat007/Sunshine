...
class WeatherDbHelper extends SQLiteOpenHelper {
  ...
  public void onCreate(SQLiteDatabase sqLiteDatabase) {
    final String sqlCreateLocationTable =
        "CREATE TABLE " + WeatherContract.LocationEntry.TABLE_NAME + "("
            ...
            + WeatherContract.LocationEntry.COLUMN_CITY_ID + " TEXT UNIQUE NOT NULL,"
            + WeatherContract.LocationEntry.COLUMN_COORD_LAT + " REAL NOT NULL, "
            + WeatherContract.LocationEntry.COLUMN_COORD_LONG + " REAL NOT NULL" + ");";

    final String sqlCreateWeatherTable = "CREATE TABLE "
        ...
        + " FOREIGN KEY ("
        + WeatherContract.WeatherEntry.COLUMN_LOC_KEY + ") REFERENCES "
